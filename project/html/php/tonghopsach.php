...
<body>
    <?php
    $sql_cate = mysqli_query($con, "SELECT * FROM sanpham,nhaxuatban,giatien WHERE sanpham.trangthai = 1 AND sanpham.id_nhaxuatban=nhaxuatban.id_nhaxuatban AND sanpham.id_sanpham=giatien.id_sanpham ");
    ?>
